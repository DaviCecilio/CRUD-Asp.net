...
namespace DAL
{
    class DALOficina : DALMysql
    {
       public DALOficina(string servidor, string bancodedados, string usuario, string senha)
        {
    ...
    abstract class DALMysql
    {
        ...
        protected int ExecutarComando(string SQL) //insert, delete e update
        {
            try
            {
                Conectar();
